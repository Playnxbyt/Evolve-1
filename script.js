...
function toggleTaskCat(catId) {
  ...
  const chevron=document.getElementById(`cat-expand-${catId}-chevron`);
  if(!panel) return;
          ...
          return `<div class="task-month-cat-card" style="border-color:${cat.color}22;background:${cat.bg}">
            <div class="task-month-cat-header" onclick="toggleTaskCat('${cat.id}')">
              ...
              <div style="display:flex;align-items:center;gap:8px">
                ...
                <span class="task-cat-chevron" id="${expandId}-chevron" style="color:rgba(255,255,255,0.3);font-size:12px;transition:transform 0.25s ease">▼</span>
              </div>
            </div>
