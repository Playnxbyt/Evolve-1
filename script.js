...
function renderHome() {
  ...
  list.innerHTML=CATS.map(cat=>{
    ...
    return `<div class="cat-card" style="background:${cat.bg};border:1px solid ${cat.color}28;box-shadow:${isExp?`0 0 28px ${cat.color}35`:"none"}">
...
function renderCalendar() {
  ...
  for(let d=1;d<=days;d++){
    ...
    html+=`<div class="cal-day${isToday?" today":""}" style="background:${bg};border:${border};${shadow}" onclick="showDayGoals(${y},${m},${d})">
